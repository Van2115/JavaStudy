public class Array05 {
    public static void main(String[] args){
        ...
        array1[1] = new ItemForArray(500, "바나나");
        array1[2] = new ItemForArray(500, "수박");

        ItemForArray[] array2 = new ItemForArray[]{new ItemForArray(500, "사과"),new ItemForArray(500, "바나나"),new ItemForArray(500, "수박")};
        ItemForArray[] array3 = {new ItemForArray(500, "사과"),new ItemForArray(500, "바나나"),new ItemForArray(500, "수박")};
